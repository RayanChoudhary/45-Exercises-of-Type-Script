...
let current_users = ["Arsalan","Irfan","Noman","Shayan","Huzaifah"];

let new_users = ["Rayan","Toshi","Arsalan","Mashood","Irfan"]

new_users.forEach(newuser => {
    let our_condition = current_users.some(currenttuser => currenttuser.toLocaleLowerCase() === newuser.toLocaleLowerCase())
